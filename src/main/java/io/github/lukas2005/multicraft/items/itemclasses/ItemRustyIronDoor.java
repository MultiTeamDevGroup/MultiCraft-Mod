...
public class ItemRustyIronDoor extends ItemBlock {
    public ItemRustyIronDoor() {
        super(new BlockRustyIronDoor());
        this.setUnlocalizedName(Main.MODID + ".rusty_iron_door");
        this.setRegistryName("rusty_iron_door");
    }
    ...
    public void registerItemModel() {
        Main.proxy.registerItemRenderer(this, 0, "rusty_iron_door");
    }
}
