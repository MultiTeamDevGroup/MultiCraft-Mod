...
public class IngredientStack
{
    ...
    public boolean matches(Object input)
    {
        ...
        else if(input instanceof String)
        {
            ...
            return CraftingUtils.compareToOreName(stack, (String)input);
        }
        return false;
    }
    ...
    public List<ItemStack> getSizedStackList()
    {
        ...
        if(oreName!=null)
        {
            ...
            for(ItemStack stack : OreDictionary.getOres(oreName))
                list.add(CraftingUtils.copyStackWithAmount(stack, inputSize));
        }
            ...
            list = Collections.singletonList(CraftingUtils.copyStackWithAmount(stack, inputSize));
        return list;
    }
    ...
    public Ingredient toRecipeIngredient()
    {
        ...
        if(ret==null&&stackList!=null&&stackList.size() > 0)
            ret = CraftingUtils.createIngredientFromList(stackList);
    ...
    public boolean matchesItemStack(ItemStack input)
    {
        ...
        if(this.oreName!=null)
            return CraftingUtils.compareToOreName(input, oreName)&&this.inputSize <= input.getCount();
    ...
    public boolean matchesItemStackIgnoringSize(ItemStack input)
    {
        ...
        if(this.oreName!=null)
            return CraftingUtils.compareToOreName(input, oreName);
        if(this.stackList!=null)
        {
            for(ItemStack iStack : this.stackList)
